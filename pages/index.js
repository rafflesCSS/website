        ...
        <div className={utilStyles.parent}>
            ...
            <section className={utilStyles.alternate}>
                ...
                <div className={utilStyles.container}>
                    <p>
                        Do you want to learn coding but you're not sure how to
                        begin? Well, look no further! We are the Computer
                        ...
                        , so you know that our members are extremely diverse. We
                        welcome students of all skill levels, from absolute
                        beginners to programming experts.
                    </p>
                    <p>
                        By the way, sessions are held every Wednesday (our
                        school's Gap Day) from 9 to 11am!
                    </p>
                </div>
            </section>
                    ...
                    <div className={utilStyles.slides}>
                        ...
                        >
                            <blockquote>
                                ...
                                passionate about programming! The courses it
                                offers are useful and interesting, and the
                                incubator programme, in particular, promotes
                                creativity and presents the chance for members
                                to experiment and create innovative projects. By
                                and large, anyone who wants to learn computer
                                science should definitely try out for CSS!"
                            </blockquote>
